...
const PSBDiscounts = () => {
  const [isDiscountOnTotalBillPopUpOpen, setIsDiscountOnTotalBillPopUpOpen] =
    useState(false);
  const [
    isDiscountOnEquipmentOrItemPopUpOpen,
    setIsDiscountOnEquipmentOrItemPopUpOpen,
  ] = useState(false);
  const [
    isAdvanceAndDiscountConfirmationPopUpOpen,
    setIsAdvanceAndDiscountConfirmationPopUpOpen,
  ] = useState(false);
    ...
    <div className="rightInContent">
      <div className="wrapper min-h-full">
        <div className="space-y-8 h-full">
          ...
          <div className="space-y-5">
            <div
              onClick={() => setIsDiscountOnTotalBillPopUpOpen(true)}
              className="bg-gradient-to-r from-[#13e1b094] to-[#13E1B0] p-5 pr-8 rounded-lg"
            >
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <span className="text-xs text-white font-normal">
                    4 Event can be posted or one with max 30 day
                  </span>
                </div>
                <div>
            ...
            <div
              onClick={() => setIsDiscountOnEquipmentOrItemPopUpOpen(true)}
              className="bg-gradient-to-r from-[#20c0e878] to-[#20C0E8] p-5 pr-8 rounded-lg"
            >
              <div className="flex justify-between items-center">
                <div>
            ...
            <div
              onClick={() => setIsAdvanceAndDiscountConfirmationPopUpOpen(true)}
              className="bg-gradient-to-r from-[#faba1585] to-[#FABA15] p-5 pr-8 rounded-lg"
            >
              <div className="flex justify-between items-center">
                <div>
      ...
      <Modal isOpen={isDiscountOnTotalBillPopUpOpen}>
        <EventPopUpDiscountOnTotalBill
          handleClose={setIsDiscountOnTotalBillPopUpOpen}
        />
      </Modal>
      <Modal isOpen={isDiscountOnEquipmentOrItemPopUpOpen}>
        <EventPopUpDiscountOnEquipmentOrItem
          handleClose={setIsDiscountOnEquipmentOrItemPopUpOpen}
        />
      </Modal>
      <Modal isOpen={isAdvanceAndDiscountConfirmationPopUpOpen}>
        <EventPopUpAdvanceAndDiscountConfirmation
          handleClose={setIsAdvanceAndDiscountConfirmationPopUpOpen}
        />
      </Modal>
    </div>
  );
