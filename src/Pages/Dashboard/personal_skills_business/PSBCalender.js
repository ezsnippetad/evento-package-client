          ...
          <div className="space-y-5">
            <div className="flex items-end -mx-3.5">
              <div className="w-full lg:w-1/3 px-3.5">
                ...
                <label className="bg-white rounded-md flex space-x-3 relative">
                  ...
                  <input
                    type="date"
                    className="w-full rounded-md outline-none appearance-none pl-10 py-4"
                  />
                </label>
              </div>
              <div className="w-full lg:w-1/3 px-3.5">
            ...
            <div className="calendar inline-block justify-center items-center rounded-md drop-shadow-one bg-white w-full px-12 py-7">
              ...
              <div className="dates flex flex-wrap rounded-md overflow-hidden border border-gray-200">
                <div className="calender_number" style="color: #B8B8B8;">
                  30
                </div>
                <div className="calender_number" style="color: #B8B8B8;">
                  31
                    ...
                    <li>
                      <span>
                        ...
                        >
                          {" "}
                          <path
                            d="M1.0791 0C1.3916 0 1.64876 0.100911 1.85059 0.302734C2.05566 0.504557 2.1582 0.761719 2.1582 1.07422C2.1582 1.38672 2.05566 1.64551 1.85059 1.85059C1.64876 2.05566 1.3916 2.1582 1.0791 2.1582C0.766602 2.1582 0.507812 2.05566 0.302734 1.85059C0.100911 1.64551 0 1.38672 0 1.07422C0 0.761719 0.100911 0.504557 0.302734 0.302734C0.507812 0.100911 0.766602 0 1.0791 0Z"
                            fill="#2E363F"
                          />{" "}
                        </svg>
                      </span>
                      Lorem ipsum <i className="icon-dark-fill-time"></i> 08:45
                      AM
                    </li>
                    <li>
                      <span>
