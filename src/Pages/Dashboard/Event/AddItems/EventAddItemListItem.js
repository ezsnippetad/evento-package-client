...
import RemoveItem from "../../../../component/Popups/DashboardPopup/RemoveItem";
...
const EventAddItemListItem = ({
  ...
  return (
    <div className="bg-white rounderd px-7 py-4 max-[600px]:px-4">
              ...
              <div className="flex items-center">
                ...
                <svg
                  ...
                  data-pr-tooltip={intl.formatMessage({
                    id: "LET USERS KNOW THE AVAILABILITY OF THE ITEM",
                  })}
      ...
      <Modal isOpen={removeItem}>
        <RemoveItem
          handleClose={setRemoveItem}
          data={data}
          setReload={setReload}
        />
      </Modal>
