...
import { videoUpload } from "../../redux/services/eventServices/companyDetailsServices";
...
export const additemId = createAsyncThunk("event/additembyid", async (id) => {
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(createNewEvent.fulfilled, (state, action) => {
      localStorage.setItem(
        "displayName",
        action.payload.data?.Data?.display_name,
      );
    });
  },
});
