            ...
            <div className="px-1 md:px-3.5 w-full">
              <div className="block p-4 shadow-lg bg-white rounded-lg relative">
                ...
                <div className="pt-5 px-2">
                  ...
                  <h2 className="text-japaneseIndigo text-lg xl:text-2xl font-semibold py-2">
                    DJ Lemon
                  </h2>
                  <div className="flex justify-between items-center pt-4 border-t border-[#dddddd]">
                    <span className="p-1 px-2 text-lg font-bold text-spiroDiscoBall mr-3">
                      250 INR
                    </span>
            ...
            <div className="px-1 md:px-3.5 w-full">
              <div className="block p-4 shadow-lg bg-white rounded-lg">
                <img
                  src={dj}
                  alt="card-1"
                  className="object-cover w-full h-56 rounded-md relative  "
                />
                <span className="block absolute top-6 left-0 leading-4 bg-spiroDiscoBall text-white text-sm font-bold py-1 px-2.5">
                  DJ
                </span>
