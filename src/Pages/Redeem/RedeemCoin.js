    ...
    <div className="wrapper min-h-full">
      <div className="space-y-7 h-full">
        ...
        <div className="flex justify-between items-center">
          ...
          <button type="button" className="btn-primary text-base">
        ...
        <div className="py-3.5 px-5 rounded-lg bg-spiroDiscoBall flex items-center justify-between">
          ...
          <h1 className="text-white max-[600px]:flex max-[600px]:flex-col max-[600px]:items-center">
            <span className="font-normal">
              <span>{intl.formatMessage({ id: "YOU HAVE :" })}</span>
            </span>
            <span>
              {fCoin} {intl.formatMessage({ id: "F-COINS" })}
            </span>
          </h1>
          <svg
            width="62"
        ...
        <div className="space-y-2.5">
          {loading ? (
            ...
            <>
              {redeem.length === 0 ? (
                <h3 className="text-quicksilver font-bold capitalize text-center">
                  {intl.formatMessage({ id: "NO REDEEM HISTORY FOUND!" })}
                </h3>
              ) : (
                <>
                  {redeem.map((e) => (
                    <div
                      key={e._id}
                      className="flex items-center justify-between p-2.5 bg-white rounded-md"
                    >
                      <div className="flex items-center space-x-4">
                        <div className="rounded bg-[#FFF0C8] text-3xl w-14 h-14 flex items-center justify-center">
                          {e.transaction_type === "refer" ? (
                            <i className="icon-users"></i>
                          ) : e.transaction_type === "redeem" ? (
                            <i className="icon-reward"></i>
                          ) : e.transaction_type === "send" ? (
                        ...
                        <div>
                          <h3 className="text-base">
                            <span>
                              {e.transaction_type === "refer"
                                ? intl.formatMessage({ id: "LOGIN REFER" })
                                : e.transaction_type === "redeem"
                                ? intl.formatMessage({ id: "COIN REDEEM" })
                                : e.transaction_type === "send"
                                ? intl.formatMessage({ id: "COIN SEND" })
                                : ""}
                            </span>
                          </h3>
                          ...
                          <span className="input-titel capitalize">
                            Refer By{" "}
                            {e?.receiver_id?._id ==
                            e?.refer_data?.from_refer?._id
                              ? e?.refer_data?.to_refer?.name
                              : e?.refer_data?.from_refer?.name
                              ? e?.refer_data?.from_refer?.name
                              : e?.refer_data?.from_refer?.name}
                          </span>
                        </div>
                      ...
                      <div className="flex items-center">
                        <p className="pr-5 border-r-2 border-quicksilver">
                          <span>{moment(e?.timestamp).format("ll")}</span>
                        </p>
                        <h3 className="pl-5 pr-3 text-ufoGreen">
                          +{e.f_coins}
                        </h3>
                      </div>
                    </div>
