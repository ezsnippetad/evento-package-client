...
import {
  ...
  notificationSetting,
  payNow,
} from "../../../../redux/services/notificationEventServices/billDetailsServices";
...
export const selectGetOne = (state) =>
  state.billDetails.notificationGetOneDetails;
...
export const selectSetting = (state) =>
  state.billDetails.settingNotificationDetails;
