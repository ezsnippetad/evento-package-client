  ...
  useEffect(() => {
    ...
    setTotalNotificationPrice(
      notificationGetOneDetails?.is_notification === true &&
        notificationGetOneDetails?.numberofusers
        ...
        <div className="wrapper min-h-full">
          ...
          <div className="bg-white rounded p-8 mt-6 space-y-5">
                ...
                <div className="w-full flex justify-between">
                  <div className="">
                    ...
                    <span className="text-sm text-gray-300 font-normal">
                      {notificationGetOneDetails?.numberofusers}{" "}
                      {intl.formatMessage({ id: "USERS" })} x {notificationCost}{" "}
                      ₹
                    </span>
                  </div>
              ...
              <div className="flex items-start">
                ...
                <div className="w-full flex justify-between">
                  <div className="">
                    ...
                    <span className="text-sm text-gray-300 font-normal">
                      {notificationGetOneDetails?.numberofusers}
                      {intl.formatMessage({ id: "PHONE NUMBER" })} x {smsCost} ₹
                    </span>
                  </div>
                  <div className="flex items-center text-2xl text-japaneseIndigo">
                    <i className="icon-rs rs-black text-base mr-3"></i>
              ...
              <div className="flex items-start">
                ...
                <div className="w-full flex justify-between">
                  <div className="">
                    ...
                    <span className="text-sm text-gray-300 font-normal">
                      {notificationGetOneDetails?.numberofusers}{" "}
                      {intl.formatMessage({ id: "EMAIL ID" })}x {emailCost} ₹
                    </span>
                  </div>
                  <div className="flex items-center text-2xl text-japaneseIndigo">
                    <i className="icon-rs rs-black text-base mr-3"></i>
            ...
            <div className="flex justify-between capitalize">
              ...
              <h2>
                <i className="icon-rs rs-black text-lg"></i>{" "}
                {totalNotificationPrice + totalSmsPrice + totalEmailPrice}
              </h2>
            </div>
          </div>
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-4">
                        <div className="text-base font-bold">
                          {intl.formatMessage({ id: "APPLY COUPONS" })}
                        </div>
                        <p className="text-sm font-normal text-[#9BA0A8]">
                          {intl.formatMessage({
                            id: "THERE IS BEST OFFER FOR YOU PLEASE CHECK",
                          })}
                        </p>
                      </div>
                    </div>
