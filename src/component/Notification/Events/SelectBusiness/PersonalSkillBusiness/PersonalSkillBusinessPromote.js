  ...
  return (
    <div>
        ...
        <div className="bg-white rounded p-8 mt-6 space-y-5">
          <div className="flex items-start">
            ...
            <div className="w-full flex justify-between">
              ...
              <div className="flex items-center text-xl xl:text-2xl text-japaneseIndigo">
          ...
          <div className="flex justify-between capitalize text-magicPotion">
            ...
            <h2>
              -{" "}
              <i className="icon-rs text-lg before:text-magicPotion before:content-['\e921']"></i>{" "}
              30
            </h2>
          </div>
      ...
      <div className="flex justify-between items-center border border-caribbeanGreen rounded-md px-5 py-6 bg-green-50">
        <div>
          <h3 className="text-caribbeanGreen pb-2">
            Coupon applied - You saved ₹30
          </h3>
          <span className="text-sm text-quicksilver">
            Coupon Code : 5489off
          </span>
        </div>
        <div>
          <Link to="/">
            <i className="icon-delete text-2xl"></i>
          </Link>
        </div>
      </div>
      {/* <!-- pay now button  --> */}
