        ...
        <div className="flex items-center space-x-2 pb-5 border-b w-9 h-9 over">
          <img
            src={
              data?.data &&
              data?.data?.userid &&
              data?.data?.userid?.profile_pic &&
              data?.data?.userid?.profile_pic !== ""
                ? s3Url + "/" + data?.data?.userid?.profile_pic
                : userImg
            }
            alt="user-3"
        ...
        <div className="flex items-center pt-5 space-x-7">
          <div>
            <span className="text-xs text-quicksilver font-bold">
              <i className="icon-calendar2 pr-2"></i>Date
            </span>
            <p className="text-base">{data?.data?.start_date}</p>
          </div>
          <div className="border-x px-7">
            <span className="text-xs text-quicksilver font-bold">
              <i className="icon-light-fill-time pr-2"></i>Time
            </span>
            <p className="text-base">{data?.data?.start_time}</p>
          </div>
          <div>
            <span className="text-xs text-quicksilver font-bold">
              <i className="icon-location pr-2"></i>Location
            </span>
