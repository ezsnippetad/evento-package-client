...
export const RESEND_OTP = "/organizer/register/forgotpassword";
...
export const IMPORT_CSV = "organizer/notification/import";
export const GET_CSV_USER = "/organizer/notification/userlist";
export const SELECT_USER_FOR_NOTIFICATION = "organizer/notification/checkuser";
export const SELECT_ALLUSER_FOR_NOTIFICATION =
  "organizer/notification/checkalluser";
